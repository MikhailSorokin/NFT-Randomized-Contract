 ...
 */
contract ERC721r is Context, ERC165, IERC721Metadata, IERC721Enumerable {
    ...
    // ONLY ALLOW ONE TO MINT (MIKE 4/21)
    ...
    /******************** OVERRIDING IERC721Enumerable functionality *****************************/
    
     /**
     * @dev Returns the total amount of tokens stored by the contract. OVERRIDES IERC721Enumerable
     */
    ...
    event MintError(string message);
    ...
    function _mintRandom(address to, uint _numToMint) internal virtual {
        ...
        if (_balances[_msgSender()] >= 1)
        {
            emit MintError("You can only mint one random NFT!");
        }
        require(_balances[_msgSender()] < 1, "You can only mint one random NFT!");
        ...
        // Addition to make sure that supply is valid
        require(totalSupply() < maxSupply(), "ERC721r: Maximum supply reached, cannot mint more NFTs");
  ...
  // Mapping from owner to list of owned token IDs
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(ERC721r.ownerOf(index) == msg.sender, "ERC721r: this user is not the owner of this token");
        require(index < ERC721r.totalSupply(), "ERC721Enumerable: global index out of bounds");
    ...
    // Need to implement, but does nothing
